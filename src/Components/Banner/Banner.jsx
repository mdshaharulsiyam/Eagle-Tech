            ...
            <div className='container mx-auto flex md:flex-row flex-col-reverse flex-wrap md:justify-center justify-start  gap-2 items-center '>
                <div className='md:w-[49%] w-full flex justify-start items-center text-center md:text-left'>
                    <span>
                        ...
                        <p className='md:text-base italic text-white opacity-90'>Eagle Tech Shop: Explore cutting-edge tech, elevate your digital experience. Discover style and functionality in our top-tier gadgets. Redefine your tech lifestyle with us.".</p>
